...
class class_2_Processor(DataProcessor):
...
#     output_predict_file = os.path.join(FLAGS.output_dir, "test_results.tsv")
    ...
    output_predict_file = os.path.join(FLAGS.output_dir, FLAGS.output_tsv_name)
